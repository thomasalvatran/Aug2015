...
//Method 4: anonymous function object
//    unordered_map<Name, int, [](string a, string b) {return hash<string>()(a) ^ hash<string>()(b);}> ids1;

    ids[Name("Mark", "Nelson")] = 40561;
    ids[Name("Andrew","Binstock")] = 40562;
//    ids.insert(pair<string, string> ([Name("test", "test")]));
//    ids.insert(pair<string, string> (Name("Tom", "Tran")));
//    ids.insert(make_pair("tom", 40000));
